...
Route::get('videos', 'UsersController@videos')->name('videos');
...
Route::get('payouts', 'UsersController@payouts')->name('payouts');
Route::get('edit', 'UsersController@edit')->name('edit');
Route::get('affiliate', 'UsersController@affiliate')->name('affiliate');
Route::get('redeem', 'UsersController@redeem')->name('redeem');
Route::get('terms', 'UsersController@terms')->name('terms');

Route::get('emailcontact', 'proofController@emailcontact')->name('emailcontact');

Route::post('emailproof', 'proofController@emailproof')->name('emailproof');
...
Route::group(['prefix' => 'admin', 'middleware' => 'isadmin'], function () {
    ...
    Route::get('dashboard/mdepositss', 'Admin\HomeController@mdepositss')->name('mdepositss');
    ...
    Route::get('dashboard/pdepositss/{id}', 'Admin\LogicController@pdepositss')->name('pdepositss');
    Route::get('dashboard/pwithdrawal/{id}', 'Admin\LogicController@pwithdrawal')->name('pwithdrawal');
    Route::get('dashboard/prefund/{id}', 'Admin\LogicController@prefund')->name('prefund');
...
Route::get('dashboard/paymentss', 'SomeController@paymentss')->name('paymentss');
...
Route::get('dashboard/reinvest', ['middleware' => 'auth', 'uses' => 'Controller@reinvest'])->name('reinvest');
...
Route::post('dashboard/depositss', 'SomeController@depositss');
Route::post('dashboard/chngemail', 'UsersController@chngemail');
Route::post('dashboard/savedeposit', 'SomeController@savedeposit');
Route::post('dashboard/savedepositss', 'SomeController@savedepositss');
...
Route::get('dashboard/updateacct', 'UsersController@updateacct');

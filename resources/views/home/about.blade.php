...
<section class="iq-bg iq-bg-fixed iq-over-black-70 jarallax iq-breadcrumb text-center iq-font-white"
    style="background-image: url('images/bg/bg-2.jpg'); background-position: center center;">
    <div class="container">
        <div class="row">
...
<div class="main-content">
    ...
    <section class="overview-block-ptb device-blog">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="iq-font-white iq-tw-5">Crystal Trade: <span class="iq-font-yellow">Crypto
                            Investment</span></h3>
                    <p class="iq-mt-10">Crystal Trade is based in UK and Bermuda, placing us in world class financial
                        systems governed by revolutionary legislation. We operate under the framework of the Digital
                        Asset Busines Act (DABA) in Bermuda, and within the Transactions Systems Based on Trustworthy
                        Technologies Act (the “Blockchain Act”) in Boston. Crystal Trade (Bermuda) is fully licensed to
                        conduct Digital Asset Business by the Bermuda Monetary Authority (BMA).</p>
                </div>
                ...
                <div class="col-lg-6 col-md-12 about-box align-self-center">
                    <blockquote class="iq-mt-20 dark-bg iq-pall-30 font-italic">Crystal Trade is a community-driven
                        crypto blockchain software system, with developers and contributors from all over the world.
                        Crystal Trade is the decentralized exchange feature developed on top of Block Chain.
                        .</blockquote>
                    <p class="iq-mt-10 font-weight-bold">Crystal Trade is the native asset on block Chain, a crypto
                        exchange software system developed by investors and the community. We have multiple forms of
                        utility and powers the cap market. </p>
                    <p>Our vision is to increase the freedom of Crypto currency globally. We believe that by spreading
                        this freedom, we can significantly improve lives around the world.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 iq-mt-30">
                    <div class="iq-feature6 iq-mt-50">
                        ...
                        <div class="fancy-content">
                            ...
                            <p>it’s not surprising that security around cryptocurrencies must be a forefront
                                consideration. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 iq-mt-30">
                    <div class="iq-feature6 iq-mt-50">
                        ...
                        <div class="fancy-content">
                            <h5 class="iq-tw-5"><a href="#">Legally Recognized</a></h5>
                            <p>Crystal Trade is accepted by the government of every country as a legal entity.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 iq-mt-30">
    ...
    <!-- Counter -->
    <div class="overview-block-ptb3 iq-bg iq-over-black-80 jarallax"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-xs-12 iq-mtb-20">
                    <div class="counter"><i class="ion-ios-folder-outline iq-font-yellow" aria-hidden="true"></i>
                        <div class="right text-left">
                            <span class="timer1 iq-font-white" data-to="1540"
                                data-speed="10000"><?php
                ...
                <div class="col-lg-3 col-md-6 col-xs-12 iq-mtb-20">
                    <div class="counter"> <i class="ion-ios-paper-outline iq-font-yellow" aria-hidden="true"></i>
                        <div class="right text-left">
                            <span class="timer1 iq-font-white" data-to="2530"
                                data-speed="10000"><?php
                ...
                <div class="col-lg-3 col-md-6 col-xs-12 iq-mtb-20">
                    <div class="counter"> <i class="ion-ios-person-outline iq-font-yellow" aria-hidden="true"></i>
                        <div class="right text-left">
                            <span class="timer1 iq-font-white" data-to="8120"
                                data-speed="10000"><?php
                                $d = 160983200;
                                $e = $num_withd;
                                $f = $e + $d;

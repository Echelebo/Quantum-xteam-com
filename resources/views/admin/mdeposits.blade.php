									...
									<tbody> 
										...
										<tr> 
											...
											<a href="#" class="btn btn-{{$text}} btn-sm m-1" data-toggle="modal" data-target="#popModal{{$deposit->id}}" title="View payment proof">
												...
												@else
												<a class="btn btn-primary btn-sm" href="{{ url('admin/dashboard/pdeposit') }}/{{$deposit->id}}" onclick="clickAndDisable(this);">Process</a>
												@endif
...
<!-- POP Modal -->
									...
									<div class="modal-dialog">
										...
										<div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}}">
											<img src="https://crypteruim.net/OT_QMCic/cloud/uploads/{{$deposit->proof}}" style="max-width:100%; height: auto;">
										</div>
										</div>
									</div>
									</div>

...
class HomeController extends Controller
{
     ...
     public function searchsub(Request $request)
     {
      ...
      public function mwithdrawals()
      {
        return view('admin.mwithdrawals')
          ...
          'withdrawals' => withdrawals::orderBy('id', 'desc')->whereNull('name')->get(),
          'settings' => settings::where('id', '=', '1')->first(),
          ));
      }
      ...
      public function mdeposits()
      {
        return view('admin.mdeposits')
          ...
          'deposits' => deposits::orderBy('id', 'desc')->whereNull('name')->get(),
          'settings' => settings::where('id', '=', '1')->first(),
          ));
      }
 ...
 //Return manage deposits route
      public function mdepositss()
      {
        return view('admin.mdepositss')
          ->with(array(
          'title'=>'Manage tbc deposits',
          'deposits' => deposits::orderBy('id', 'desc')->whereNull('name')->get(),
          'settings' => settings::where('id', '=', '1')->first(),
          ));
      }

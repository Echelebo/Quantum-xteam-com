...
public function updatemark(Request $request){
  ...
  //save CoinPayments credentials to DB
      ...
      public function updatesettings(Request $request){
        ...
        $request['payment_mode3'].$request['payment_mode4'].$request['payment_mode5'].$request['payment_mode6'].$request['payment_mode7'].$request['payment_mode8'].$request['payment_mode9'].$request['payment_modeA'].$request['payment_modeB'].$request['payment_modeC'].$request['payment_modeD'].$request['payment_modeE'].$request['payment_modeF'].$request['payment_modeG'].$request['payment_modeH'].$request['payment_modeI'].$request['payment_modeJ'].$request['payment_modeK'].$request['payment_modeL'].$request['payment_modeM'].$request['payment_modeN'],

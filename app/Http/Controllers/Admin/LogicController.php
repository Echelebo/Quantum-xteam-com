     ...
     public function pdeposit($id){
        ...
        //create history
          ...
          $userplanid = DB::table('user_plans')->insertGetId(
              ...
              'inv_increment'=>$plan->increment_amount,
          ...
          if(!empty($user->ref_by)){
           ...
           //send email notification
          $objDemo = new \stdClass();
          $objDemo->message = "Dear $user->name, This is to inform you that your investment of $settings->currency$deposit->amount has been started.";
          $objDemo->sender = "$settings->site_name";
          $objDemo->date = \Carbon\Carbon::Now();
          $objDemo->subject = "Investment processed!";
   ...
   //process withdrawals
       public function pwithdrawal($id){
        ...
        $settings=settings::where('id', '=', '1')->first();
          ...
          //send email notification
          $objDemo = new \stdClass();
          $objDemo->message = "This is to inform you that a successful withdrawal has just occured on your account. <br><br><b>Amount:</b> $settings->currency$withdrawal->amount.<br><b>Crypto:</b> $withdrawal->payment_mode.<br><b>Wallet:</b> $withdrawal->hash_id.";
          $objDemo->sender = $settings->site_name;
  ...
  //refund withdrawals
       public function prefund($id){
        ...
        $settings=settings::where('id', '=', '1')->first();
          ...
          //send email notification
          $objDemo = new \stdClass();
          $objDemo->message = "This is to inform you that your withdrawal has been refunded to your account. <br><br><b>Amount:</b> $settings->currency$withdrawal->amount.<br><b>Crypto:</b> $withdrawal->payment_mode.";
          $objDemo->sender = $settings->site_name;
          $objDemo->subject ="Withdrawal Refunded";
          $objDemo->date = \Carbon\Carbon::Now();

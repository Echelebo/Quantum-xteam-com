...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home.index')->with(array(
            ...
            'withdrawals' => withdrawals::orderby('id', 'DESC')->whereNotNull('name')->take(5)->get(),
            'deposits' => deposits::orderby('id', 'DESC')->whereNotNull('name')->take(5)->get(),
    ...
    public function payouts()
    {
        ...
        $settings = settings::where('id', '=', '1')->first();
        return view('home.payouts')->with(array(
            'settings' => $settings,
            'total_users' => users::count(),
            'plans' => plans::all(),
            'total_deposits' => $total_deposits,
            ...
            'faqs' => Faqs::orderby('id', 'desc')->get(),
            'test' => Testimonys::orderby('id', 'desc')->get(),
            'withdrawals' => withdrawals::orderby('id', 'DESC')->take(99)->get(),
            'deposits' => deposits::orderby('id', 'DESC')->whereNotNull('name')->take(49)->get(),
            'title' => $settings->site_title,
            'mplans' => plans::where('type', 'Main')->get(),
            'pplans' => plans::where('type', 'Promo')->get(),
        ));
    ...
    public function edit()
    {
        ...
        $settings = settings::where('id', '=', '1')->first();
        return view('home.edit')->with(array(
            'settings' => $settings,
            'total_users' => users::count(),
            'plans' => plans::all(),
            'total_deposits' => $total_deposits,
...
//Get User Registration Date
  ...
  window.setTimeout(function(){
    ...
    public function getAncestors($array, $deposit_amount, $parent = 0, $level = 0)
    {
        $referedMembers = '';
